  ...
  {{-- <div class="sales-category-wrapper">
      ...
      <div class="brands-slider">
          <div class="card rounded-3">
              <div class="card-body">
                  <a href="shop.html"><img src="https://via.placeholder.com/330X88" class="img-fluid" alt=""></a>
              </div>
          </div>
          <div class="card rounded-3">
              <div class="card-body">
                  <a href="shop.html"><img src="https://via.placeholder.com/330X88" class="img-fluid"
                          alt=""></a>
              </div>
          </div>
          <div class="card rounded-3">
