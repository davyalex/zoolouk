...
@foreach ($subcategory_with_product as $item)
    {{-- $product is category or section --}}
    <div class="sales-category-wrapper">
        <div class="section-cat">
            {{-- category  or section --}}
            <h5 class="my-2 text-center fw-bold section-title " style="text-transform:uppercase">{{ $item['name'] }} 
                <a href="/shop?category={{$item['id']}}" class="text-white">
                    <i class="py-1" style="float:right; font-size:12px">VOIR TOUT <i class="bi bi-chevron-right"></i> </i>
