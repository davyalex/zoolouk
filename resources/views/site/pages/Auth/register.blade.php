    ...
    @guest
        ...
        <div class="page-content">
            ...
            <div class="login-body">
                ...
                <p class="mb-0">Créer votre compte pour continuer vos achats</p>
                <form class="mt-4 needs-validation" method="POST" action="{{ route('register') }}" novalidate>
                    @csrf
                    <div class="form-floating mb-3">
                        <input type="text" name="name" class="form-control rounded-3" id="floatingInputName"
                            placeholder="Entrer votre Nom et prenoms" required>
                    ...
                    <div class="form-floating mb-3">
                        <input type="number" name="phone" class="form-control rounded-3" id="floatingInputEmail"
                            placeholder="07 000 000 00" required>
                        <label for="floatingInputEmail">Contact</label>
                        <div class="invalid-feedback">
                            Champs obligatoire
                        </div>
                    </div>
                    ...
                    <div class="input-group mb-3" id="show_hide_password">
                        <div class="form-floating flex-grow-1">
                            <input type="password" name="password" class="form-control rounded-3 border-end-0 rounded-end-0"
                                id="floatingInputPassword" placeholder="Entrer un mot de Password" required>
                            <label for="floatingInputPassword">Password</label>
                        </div>
                        <span class="input-group-text bg-transparent rounded-3 rounded-start-0"><i
